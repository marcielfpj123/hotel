...
class HospedagemController extends AppController
{
    ...
    {
        $hospedagem = $this->Hospedagem->get($id, contain: ['Funcionario', 'Reserva', 'Ganho', 'HospedagemProdutos', 'HospedagemServicos']);
        $this->set(compact('hospedagem'));
    }
    ...
    public function add()
    {
        ...
        $this->set(compact('hospedagem', 'funcionario', 'reserva'));
    }
    ...
    {
        $hospedagem = $this->Hospedagem->get($id, contain: []);
