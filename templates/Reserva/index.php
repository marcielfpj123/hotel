        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $reserva->hasValue('cliente') ? $this->Html->link($reserva->cliente->cpf, ['controller' => 'Cliente', 'action' => 'view', $reserva->cliente->id]) : '' ?></td>
                    <td><?= $reserva->hasValue('quarto') ? $this->Html->link($reserva->quarto->tipo_quarto, ['controller' => 'Quarto', 'action' => 'view', $reserva->quarto->id]) : '' ?></td>
                    <td><?= $reserva->hasValue('funcionario') ? $this->Html->link($reserva->funcionario->cpf, ['controller' => 'Funcionario', 'action' => 'view', $reserva->funcionario->id]) : '' ?></td>
